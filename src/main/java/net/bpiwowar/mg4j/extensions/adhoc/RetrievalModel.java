...
public interface RetrievalModel {
     ...
     */
    void init(DocumentCollection collection, IndexedField index) throws Exception;
     ...
     * @param results
     */
    void process(String topicId, String topic, int capacity, TaskTimer timer, ObjectArrayList<DocumentScoreInfo<Reference2ObjectMap<Index, SelectedInterval[]>>> results, LongSet onlyDocuments) throws Exception;
}
