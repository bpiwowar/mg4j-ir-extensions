...
final public class TaskTimer extends Timer {
    ...
    public class Task {
         ...
         * @param out       The stream where things are printed
         */
         ...
         * Resets the task
         *
         * @param what  Give a new description
         * @param total Give a new total
         */
     ...
     * Default constructor
     *
     * @param logger   The logger that should be used to report
     * @param interval The interval between two reports
     */
